...
##### Table of Contents  
- [Creating a ViewComponent](#creating-a-viewcomponent)
- [Nesting ViewComponents](#nesting-components)
- [Java and Maven Examples](#java)
...
## Creating a ViewComponent with Java
