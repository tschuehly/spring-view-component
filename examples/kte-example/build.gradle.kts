...
dependencies {
    ...
    implementation("de.tschuehly:spring-view-component-core:0.8.1-SNAPSHOT")
    ...
    testImplementation(testFixtures("de.tschuehly:spring-view-component-core:0.8.1-SNAPSHOT"))
}
