...
class IntegrationTest(
    ...
    fun assertEndpointReturns(url: String, expectedHtml: String){
        ...
        assertThat(response.body?.rmWhitespaceBetweenHtmlTags())
