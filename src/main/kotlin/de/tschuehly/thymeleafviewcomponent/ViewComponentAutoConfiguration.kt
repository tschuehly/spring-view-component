...
import de.tschuehly.thymeleafviewcomponent.thymeleaf.ThymeleafViewContextContainerMethodReturnValueHandler
...
class ViewComponentAutoConfiguration {
    ...
    @ConditionalOnProperty("viewComponent.templateEngine", havingValue = "thymeleaf")
    @Configuration
